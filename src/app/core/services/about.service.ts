    ...
    professionalSummary: [
      {
        ...
        description:
          '9+ years of experience in Analysis, Design and Development of Full stack applications using modern technologies and best practices.',
      },
      {
        id: 'team-leadership',
        icon: 'pi-users',
        ...
        description:
          'Currently working as Senior Team Lead at Nitor Infotech, an Ascendion company, leading development teams and driving project success.',
      },
      {
        ...
        description:
          'Strong skills with Angular 2+, TypeScript, HTML5, CSS3, jQuery, C#, MVC, ASP.Net, Web Services, and Entity Framework.',
      },
      {
        id: 'problem-solving',
        ...
        description:
          'Extensive experience in debugging, root cause analysis, and defect resolution with strong analytical and conceptual skills.',
      },
      {
        id: 'database-design',
        icon: 'pi-database',
        ...
        description:
          'Strong analytical skills in database design, heavily involved in designing and developing database schemas and database objects.',
      },
      {
        id: 'ai-enthusiast',
        icon: 'pi-lightbulb',
        title: 'AI Enthusiast',
        description:
          'Worked with AI ML (small language models) on local machine and completed courses on Prompt engineering and context providing for AI tools.',
      },
    ],
    certifications: [
      {
